  ...
  return (
    <div className="bg-white mt-[80px] pt-[44px] pb-[34px] pl-[89px] carousel_container">
      <div className="flex carousel_heading items-center text-[#9F9F9F] font-medium text-[27px] justify-between">
        <p className="text-[#B607A4] font-medium text-[40px] whitespace-nowrap">
          Discount Sales
        </p>
        <span className="mr-[101px] cursor-pointer whitespace-nowrap">
          See All
        </span>
      </div>
      <Swiper
...
export default DiscountSalesCarousel;
